...
def EfixQapprox(detectors, E_start, E_end, npts, E_shift = 0, *, per_step=None, md=None):
    ...
    _md = {'plan_args': {'detectors': list(map(repr, detectors)),
           ...
           #'plan_pattern_module': plan_patterns.__name__,  #this is broken TODO do we need this?
           'hints': {},
          }
    try:
...
#TODO make this number of points to match bsui standard, not the number of steps.
